...
#include<math.h>
//is a header file in the standard library of the C programming language designed for basic mathematical operations.
//Most of the functions involve the use of floating point numbers
float a;
